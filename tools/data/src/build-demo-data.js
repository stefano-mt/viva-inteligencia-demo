...
const PATHS = Object.freeze({
  ...
  fixtureA: "data/fixtures/ct-a.json",
  fixtureB: "data/fixtures/ct-b.json",
  fixtureC: "data/fixtures/ct-c.json",
  fixtureD: "data/fixtures/ct-d.json",
  fixtureE: "data/fixtures/ct-e.json",
  fixtureG: "data/fixtures/ct-g.json",
  fixtureH: "data/fixtures/ct-h.json",
  fixtureI: "data/fixtures/ct-i.json",
...
export function buildCoverageReport(
  ...
  return {
    ...
    source_artifact: {
      path: "data/generated/viva-platform-demo.json",
    ...
    fixture_coverage: [
      {
        case_id: "CT-A",
        source_path: "data/fixtures/ct-a.json",
        purpose:
      ...
      {
        case_id: "CT-B",
        source_path: "data/fixtures/ct-b.json",
        purpose:
      ...
      {
        case_id: "CT-D",
        source_path: "data/fixtures/ct-d.json",
        purpose:
      ...
      {
        case_id: "CT-E",
        source_path: "data/fixtures/ct-e.json",
      ...
      {
        case_id: "CT-G",
        source_path: "data/fixtures/ct-g.json",
        purpose:
      ...
      {
        case_id: "CT-H",
        source_path: "data/fixtures/ct-h.json",
        purpose:
    ...
    geography_coverage: {
      public_artifact: {
        path: "data/generated/district-boundaries.geojson",
