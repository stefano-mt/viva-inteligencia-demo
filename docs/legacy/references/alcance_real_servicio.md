# Fase 9 definicion de alcance real del servicio

Run ID: webs_propias_phase9_2026-06-14T20-43-58-350Z

Fuente principal: webs_propias_phase8_2026-06-14T20-43-53-961Z

Esta fase traduce el scoring de Fase 8 a niveles de alcance operativo para el MVP. No ejecuta crawling externo; usa la evidencia ya generada por Fases 4 a 8.

## Resumen ejecutivo

- Inmobiliarias evaluadas: 192
- Dominios con muestra Fase 5: 139
- Dominios con matching Fase 6: 153
- Dominios con cobertura Fase 7: 139
- Incluidas en MVP automatizable: 10
- Candidatas condicionadas: 128
- Score promedio: 59
- Cobertura critica promedio universo completo: 39%
- Cobertura critica promedio dominios muestreados: 53%
...
- MVP automatizable: entra al alcance inicial productizable.
- MVP condicionado / enriquecimiento: requiere revision de campos, matching o reglas especificas antes de automatizar.
- Backlog posterior: requiere confirmar dominio oficial o completar muestra Fase 5.
- Fuera de alcance: no entra al MVP por bloqueo tecnico/legal, ausencia de URLs de proyecto o evidencia insuficiente.

## Archivos generados

- data/service_scope_matrix.csv
- reports/service_scope_final.md
- reports/webs_propias_phase9_service_scope_latest.md
- reports/webs_propias_phase9_service_scope_latest.json
- outputs/webs-propias/logs/webs_propias_phase9_2026-06-14T20-43-58-350Z/phase9-service-scope-summary.json
