...
**Estado:** HUMAN-GATE-A aprobada; P5-00C/P5-00D y P5-01–P5-06 completados. El dataset público 2.4 materializa 36 eventos explicados (31 certificados, 5 revisables), 72 puntos temporales referenciados y 6 exclusiones, con 52 fingerprints y build determinista. El motor puro filtra por escenario, resuelve detalle/evidencia y deriva una agenda de máximo tres filas. P5-06 adoptó runtime 2.4 e integró `historyContext` como estado derivado; P5-07 es el siguiente paso y las vistas permanecen sin cambios.
