...
**Estado:** HUMAN-GATE-A aprobada; P5-00C/P5-00D y P5-01–P5-07 completados. El dataset público 2.4 materializa 36 eventos explicados (31 certificados, 5 revisables), 72 puntos temporales referenciados y 6 exclusiones, con 52 fingerprints y build determinista. El motor puro filtra por escenario, resuelve detalle/evidencia y deriva una agenda de máximo tres filas. Runtime 2.4 y `historyContext` están integrados; `#activity` ya presenta el cuaderno canónico con filtros, evidencia y estados accesibles. P5-08 es el siguiente paso.
