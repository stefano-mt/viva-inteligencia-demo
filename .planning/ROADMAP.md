...
**Estado:** HUMAN-GATE-A aprobada; P5-00C/P5-00D y P5-01–P5-10 completados. El dataset público 2.4 materializa 36 eventos explicados (31 certificados, 5 revisables), 72 puntos temporales referenciados y 6 exclusiones, con 52 fingerprints y build determinista. El motor histórico filtra por escenario, resuelve detalle/evidencia y deriva una agenda de máximo tres filas. El asistente integra las siete familias cerradas en una interfaz trazable de seis bloques, con consulta no persistente, límites, referencias navegables, foco y `aria-live`. P5-11 es el siguiente paso.
