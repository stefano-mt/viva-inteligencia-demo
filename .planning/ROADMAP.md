...
**Estado:** HUMAN-GATE-A aprobada; P5-00C/P5-00D y P5-01–P5-11 completados. El dataset público 2.4 materializa 36 eventos explicados (31 certificados, 5 revisables), 72 puntos temporales referenciados y 6 exclusiones, con 52 fingerprints y build determinista. El motor histórico filtra por escenario, resuelve detalle/evidencia y deriva una agenda de máximo tres filas. El asistente integra las siete familias cerradas en una interfaz trazable de seis bloques. P5-11 incorporó histórico y asistente al gate, demostró CT-C/D/E/F/G/I/P y preservó ocho rutas × tres viewports. P5-12 es el siguiente paso.
