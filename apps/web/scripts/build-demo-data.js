...
const PATHS = Object.freeze({
  ...
  quality: "data/source/data_quality_latest.json",
  assistant: "data/source/assistant_validation_latest.json",
  agencies: "data/source/demo-pilot/agencies.json",
  pilotSelection: "data/source/demo-pilot/pilot-selection.json",
  ...
  evidenceManifest: "data/source/demo-pilot/evidence-manifest.json",
  inspectorCases: "data/source/demo-pilot/inspector-cases.json",
  transcriptions:
    "data/source/demo-pilot/evidence/ct-g-transcriptions.json",
  authorizedEvidence:
    "data/source/demo-pilot/evidence/ct-d-countertop-fragment.txt",
  typologies: "data/source/demo-pilot/typologies.json",
  facts: "data/source/demo-pilot/facts.json",
  issues: "data/source/demo-pilot/issues.json",
  events: "data/source/demo-pilot/events.json",
  geographyManifest: "data/source/geography/source-manifest.json",
  geographySource:
    "data/source/geography/district-boundaries-source.geojson",
  fixtureA: "data/source/demo-pilot/fixtures/ct-a.json",
  fixtureB: "data/source/demo-pilot/fixtures/ct-b.json",
  fixtureC: "data/source/demo-pilot/fixtures/ct-c.json",
  fixtureD: "data/source/demo-pilot/fixtures/ct-d.json",
  fixtureE: "data/source/demo-pilot/fixtures/ct-e.json",
  fixtureG: "data/source/demo-pilot/fixtures/ct-g.json",
  fixtureH: "data/source/demo-pilot/fixtures/ct-h.json",
  fixtureI: "data/source/demo-pilot/fixtures/ct-i.json",
  benchmarkPolicy: "data/source/demo-pilot/benchmark-policy.json",
  benchmarkAttributes:
    "data/source/demo-pilot/benchmark-attribute-catalog.json",
  historyPolicy: "data/source/demo-pilot/history-policy.json",
  assistantCatalog:
...
function manifestAssetInputPaths(manifest) {
  ...
  const paths = manifest.assets.map((asset) => {
    ...
    return `apps/web/public/${logicalPath}`;
  });
...
async function buildDemoBundle({
  ...
  const evidenceBundle = buildEvidenceBundle({
    ...
    readPublicAsset(logicalPath) {
      return inputs.get(`apps/web/public/${logicalPath}`) ?? null;
    }
  });
...
export function buildCoverageReport(
  ...
  return {
    ...
    source_artifact: {
      path: "apps/web/public/demo-data/viva-platform-demo.json",
    ...
    fixture_coverage: [
      {
        case_id: "CT-A",
        source_path: "data/source/demo-pilot/fixtures/ct-a.json",
        purpose:
      ...
      {
        case_id: "CT-B",
        source_path: "data/source/demo-pilot/fixtures/ct-b.json",
        purpose:
      ...
      {
        case_id: "CT-D",
        source_path: "data/source/demo-pilot/fixtures/ct-d.json",
        purpose:
      ...
      {
        case_id: "CT-E",
        source_path: "data/source/demo-pilot/fixtures/ct-e.json",
      ...
      {
        case_id: "CT-G",
        source_path: "data/source/demo-pilot/fixtures/ct-g.json",
        purpose:
      ...
      {
        case_id: "CT-H",
        source_path: "data/source/demo-pilot/fixtures/ct-h.json",
        purpose:
    ...
    geography_coverage: {
      public_artifact: {
        path: "apps/web/public/demo-data/district-boundaries.geojson",
      ...
      references: [
        ...
        "data/source/geography/source-manifest.json#/derived"
      ]
    },
    phase_gaps: [
      ...(payload.benchmark
